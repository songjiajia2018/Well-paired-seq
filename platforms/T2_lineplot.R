...
url=list(url_23_1,url_A23d,url_seqwell,url_ftd,url_dropseq11,url_dropseq12,url_dropseq77,url_10x_v2,url_10x_v3_1,url_10x_v3_2)
file=paste(url,'/R1_mouse_line.txt',sep='')
...
pdf('R2_plot_read_umi.pdf',width=6,height=3.5)
...
pdf('R2_plot_read_gene.pdf',width=6,height=3.5)
