...
# 10x
depth='40'
mouse=paste('R4_mouse',depth,sep='_')
...
pdf('R6_violin_10x_read_umi.pdf')
...
pdf('R6_violin_10x_read_gene.pdf')
...
# human mouse
depth='150'
human=paste('R4_human',depth,sep='_')
...
pdf('R6_violin_hm_read_umi.pdf',width=10,height=8)
...
pdf('R6_violin_hm_read_gene.pdf',width=10,height=8)
