...
url1=c(url_23_1,url_A23d,url_10x_v2,url_10x_v3_1,url_10x_v3_2)
url2=c(url_23_1,url_A23d,url_seqwell,url_ftd,url_dropseq11,url_dropseq12,url_dropseq77)
url3=c(url_23_1,url_A23d,url_seqwell,url_dropseq11,url_dropseq12,url_dropseq77)

# 10x
depth='35'
mouse=paste('R7_vmouse',depth,sep='_')
...
pdf('R9_violin_10x_read_umi.pdf')
...
pdf('R9_violin_10x_read_gene.pdf')
...
# human mouse
depth='150'
human=paste('R7_vhuman',depth,sep='_')
...
pdf('R9_violin_hm_read_umi.pdf',width=10,height=8)
...
pdf('R9_violin_hm_read_gene.pdf',width=10,height=8)
