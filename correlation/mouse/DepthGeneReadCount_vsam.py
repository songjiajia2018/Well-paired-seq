...
parser.add_argument('-g', '--gtf', type=str, default='/home/songjia/newdisk/YK/reference/mm10/mm10.gtf', help='gtf for htseq-count')
...
if args.sam:
    ...
    os.system("ls 3T3-4B_L2Aligned.out.sam > list_sam")
    list_sam=[]
